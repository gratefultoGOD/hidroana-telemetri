// ============================================
// GÜNLÜK TELEMETRİ DEPOLAMA SERVİSİ
// CSV dosyalarına asenkron yazma, gün listesi ve ortalamalar
// ============================================
const fs = require('fs');
...
const { DATA_DIR, CSV_HEADERS, NUMERIC_FIELDS, FLUSH_THRESHOLD, RECENT_DATA_WINDOW } = config;
